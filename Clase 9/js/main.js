...
for (const producto of productos) {
    ...
    divProductos.innerHTML = `<img src="logos e imagenes/productos/${producto.img}.png"></img> 
...
function agregarCarrito () {
    ...
    for (const producto of carrito) {
        ...
        objeto.innerHTML = `<div class="carrito-producto carrito-columna">
                                <img class="carrito-producto-img" src="logos e imagenes/productos/${producto.img}.png" width="50" height="50">
...
/* VARIABLE PARA INPUT DE CANTIDAD */
